...
class ChatIdentityBackground extends StatefulWidget {
  ...
  @override
  State<ChatIdentityBackground> createState() {
    return _ChatIdentityBackgroundState();
  }
}

class _ChatIdentityBackgroundState extends State<ChatIdentityBackground> {
  ...
  @override
  void didUpdateWidget(covariant ChatIdentityBackground oldWidget) {
